...
// ----- Playable Character ----- //
    ...
    public void attack(character target) {
        ...
        if (roll >= target.defense){ 
            System.out.println("Attack Successfull");
                int damage = (int)(Math.random() * this.equipment.statModifier) + this.strength;
    ...
    public void getWeapon(character x){
            System.out.println(x.name + "'s equipped weapon is: " + x.equipment.name);
    ...
    public void getInfo(){
        ...
        System.out.println("" + gear.get(0).name);
        System.out.println();
